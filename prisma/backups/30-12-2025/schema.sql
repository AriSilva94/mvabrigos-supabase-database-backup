...
CREATE TABLE IF NOT EXISTS "public"."shelter_dynamics" (
    ...
    "kind" "public"."dynamic_kind" NOT NULL,
    "reference_date" "date" NOT NULL,
    "entradas_de_animais" integer,
    "entradas_de_gatos" integer,
    "adocoes_de_animais" integer,
    "adocoes_de_gatos" integer,
    "devolucoes_de_animais" integer,
    "devolucoes_de_gatos" integer,
    "eutanasias_de_animais" integer,
    "eutanasias_de_gatos" integer,
    "mortes_naturais_de_animais" integer,
    "mortes_naturais_de_gatos" integer,
...
ALTER TABLE ONLY "public"."shelter_dynamics"
    ADD CONSTRAINT "shelter_dynamics_unique_ref" UNIQUE ("shelter_id", "dynamic_type", "reference_period");



ALTER TABLE ONLY "public"."shelter_dynamics"
    ADD CONSTRAINT "shelter_dynamics_wp_post_id_key" UNIQUE ("wp_post_id");
...
CREATE INDEX "idx_shelter_dynamics_kind" ON "public"."shelter_dynamics" USING "btree" ("kind");



CREATE INDEX "idx_shelter_dynamics_shelter_date" ON "public"."shelter_dynamics" USING "btree" ("shelter_id", "reference_date");
...
CREATE OR REPLACE TRIGGER "set_timestamp_shelter_dynamics" BEFORE UPDATE ON "public"."shelter_dynamics" FOR EACH ROW EXECUTE FUNCTION "public"."set_timestamp"();
...
COMMENT ON POLICY "System can insert shelter history" ON "public"."shelter_history" IS 'Sistema pode inserir registros de auditoria';



CREATE POLICY "Users can view their own shelter history" ON "public"."shelter_history" FOR SELECT USING ((( SELECT "auth"."uid"() AS "uid") = "profile_id"));



COMMENT ON POLICY "Users can view their own shelter history" ON "public"."shelter_history" IS 'Usuários visualizam apenas histórico dos próprios abrigos';
...
CREATE POLICY "shelter_dynamics_select_public" ON "public"."shelter_dynamics" FOR SELECT USING (true);
...
GRANT SELECT ON TABLE "public"."shelter_dynamics" TO "anon";
GRANT SELECT ON TABLE "public"."shelter_dynamics" TO "authenticated";
