...
COMMENT ON COLUMN "public"."shelters"."referral_source" IS 'Como o abrigo conheceu o projeto (redes_sociais, indicacao, google, evento, tv_radio, imprensa, outro)';
...
CREATE TABLE IF NOT EXISTS "public"."team_memberships" (
    ...
    CONSTRAINT "team_memberships_role_check" CHECK (("role" = ANY (ARRAY['owner'::"text", 'member'::"text", 'manager'::"text"]))),
...
COMMENT ON COLUMN "public"."volunteers"."referral_source" IS 'Como o voluntario conheceu o projeto (redes_sociais, indicacao, google, evento, tv_radio, imprensa, outro)';
...
CREATE INDEX "idx_team_memberships_manager_lookup" ON "public"."team_memberships" USING "btree" ("member_wp_user_id", "role", "status") WHERE ("role" = 'manager'::"text");
